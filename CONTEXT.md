...
- `shared/models/sexo.enum.ts` — enum `SexoEnum` com valores `Masculino`, `Feminino` e `Outro`.
...
- Adotar `computed()` e sinais (`signal`) consistentemente em vez de arrays mutáveis, se o app evoluir para Angular 21+ moderno.
